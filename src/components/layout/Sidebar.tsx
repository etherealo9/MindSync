...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="fixed left-4 top-3.5 z-[9999] flex items-center lg:hidden">
        {/* Hamburger Menu */}
        <Button 
          variant="ghost" 
          size="icon" 
          className="h-9 w-9 bg-background/95 backdrop-blur-sm shadow-sm border rounded-full"
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:block lg:fixed lg:inset-y-0 lg:left-0 lg:z-[9999] lg:w-[300px]">
        <div className="flex h-full flex-col border-r bg-background/95 backdrop-blur-lg">
